<html>
    ...
    <body>
        ...
        <p class="par">
            This is the first milestone release of the <a href="http://www.grails.org">Grails</a> port of the famous <a href="https://blueprints.dev.java.net/petstore/">Pet Store</a> application.    
        </p>
        <p class="par">
            Features so far:
        </p>
